...
export const SERVICES: ServiceDetail[] = [
  ...
  {
    slug: "small-scale-marine-construction",
    n: "09",
    title: "Small-Scale Marine Construction",
    desc: "New structures built to the same standard as everything we maintain.",
    whatItCovers: [
      "New dock construction",
      "New lift installation",
      "Small structural additions to existing waterfront",
    ],
